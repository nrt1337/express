...
const swaggerDefinition = {
  openapi: "3.0.3",
  info: {
			title: "Swagger Kudrya - OpenAPI 3.0",
			version: "1.0.0"
	},
	servers: [
	...
	components: {
			schemas: {
				models: {
							type: "object",
							properties: {
							name: 		     { type: "string", description: "user name",  example: "max"},
							modelname:     { type: "string", description: "model name", example: "model"},
							modeltype:     { type: "string", description: "model type", example: "3js"},
							object:        { type: "string", description: "object",     example: "plane"},
							description:   { type: "string", description: "model description",       example: "that's my plane"},
							comments:      { type: "string", description: "comments", example: "good plane"}
							}
					},
					APIkeys: {
							type: "object",	
							properties: {
									name: { type: "string", description: "username",	  example: "max"}
							}
					}
			},
			securitySchemes: {
